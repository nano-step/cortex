...
CRITICAL: Nếu bạn trả lời mà KHÔNG gọi cortex_perplexity_search hoặc cortex_perplexity_read_url, đó là SAI. LUÔN gọi tool trước.`
        ...
        const isImagePrompt = !hasImageKeyword && smartIntent?.category === 'agent' && /(style|art|anime|realistic|cinematic|illustration|painting|digital|pixel|watercolor|sketch|cyberpunk|3d|render|scene|landscape|portrait)/i.test(query)
